 ...
 * The installed plugin at ~/.claude/plugins/marketplaces/seanGSISG/ is a git repo.
 */
...
const INSTALLED_PLUGIN_PATH = join(homedir(), '.claude', 'plugins', 'marketplaces', 'seanGSISG');
